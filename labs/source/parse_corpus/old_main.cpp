...
int smain()
{
	...
	{
		debug_settings ds;
		ds.load(R"(C:\Users\Alexey\Documents\MySources\boost_test\x64\Debug\debug_settings.xml)");
		ds.save(R"(C:\Users\Alexey\Documents\MySources\boost_test\x64\Debug\debug_settings_out.xml)");
		std::cout << "Success\n";
	}
